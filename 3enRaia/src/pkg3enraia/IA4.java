...
public class IA4 extends IA3 {
    ...
    public IA4(String tipoFicha, String nombre) {
    ...
    public int consultarFila(int f) {
        for (int c = 0; c < 3; c++) {
    ...
    public int consultarColumna(int c) {
        for (int f = 0; f < 3; f++) {
            if (super.getTablero().consultar(new Posicion(f, c)).equals("|X|")) {
                return 0; 
            }
    ...
    public int consultarDiag1(int f, int c) {
        //C si la p es valida
    ...
    public int consultarDiag2(int f, int c) {
    ...
    public Posicion buscaPrioridad(int prioridad[][]) {
        int aux;
    ...
    public Posicion movimientoPrioridad() {
